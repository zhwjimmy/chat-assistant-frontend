                        ...
                        {message.role === 'user' ? (
                            ...
                            <div className="max-w-[70%] ml-auto flex items-end">
                                <div className="flex flex-col items-end">
                                    <div className="inline-block px-4 py-2 rounded-2xl rounded-br-md bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 break-words whitespace-pre-wrap leading-relaxed">
                                        {message.content}
                                    </div>
